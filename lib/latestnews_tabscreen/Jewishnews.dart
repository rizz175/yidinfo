...
class jewishnews extends StatefulWidget {
  const jewishnews({Key? key}) : super(key: key);

  @override
  _jewishnewsState createState() => _jewishnewsState();
}

class _jewishnewsState extends State<jewishnews> with SingleTickerProviderStateMixin {
...
//
  ...
  List ar=await catgory.getallpost("28", i);
  setState(() {
    articles=ar;
