...
class israelnews extends StatefulWidget {
  const israelnews({Key? key}) : super(key: key);

  @override
  _israelnewsState createState() => _israelnewsState();
}

class _israelnewsState extends State<israelnews> with SingleTickerProviderStateMixin {
...
//
  ...
  List ar=await catgory.getallpost("40", i);
  setState(() {
    articles=ar;
