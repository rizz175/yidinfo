...
class worldsnews extends StatefulWidget {
  const worldsnews({Key? key}) : super(key: key);

  @override
  _worldsnewsState createState() => _worldsnewsState();
}

class _worldsnewsState extends State<worldsnews> with SingleTickerProviderStateMixin{
...
//
 ...
 setState(() {
  ...
  List ar=await catgory.getallpost("27", i);
setState(() {
articles=ar;
