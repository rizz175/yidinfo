...
class stalenisland extends StatefulWidget {
  const stalenisland({Key? key}) : super(key: key);

  @override
  _stalenislandState createState() => _stalenislandState();
}

class _stalenislandState extends State<stalenisland> with SingleTickerProviderStateMixin{
...
//
  ...
  List ar=await catgory.getallpost("104", i);
  setState(() {
    articles=ar;
