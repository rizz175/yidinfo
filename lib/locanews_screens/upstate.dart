...
class upstate extends StatefulWidget {
  const upstate({Key? key}) : super(key: key);

  @override
  _upstateState createState() => _upstateState();
}

class _upstateState extends State<upstate> with SingleTickerProviderStateMixin{
...
//
  ...
  List ar=await catgory.getallpost("31", i);
  setState(() {
    articles=ar;
