...
class Boropark extends StatefulWidget {
  const Boropark({Key? key}) : super(key: key);

  @override
  _BoroparkState createState() => _BoroparkState();
}

class _BoroparkState extends State<Boropark> with SingleTickerProviderStateMixin{
...
//
  ...
  List ar=await catgory.getallpost("35", i);
  setState(() {
    articles=ar;
...
// height:MediaQuery.of(context).size.height*0.14,
                        ...
                        child:ListTile(
                          ...
                          title:Padding(
                              ...
                              Html(
                                data:"${articles[i]["title"]["rendered"]}",
