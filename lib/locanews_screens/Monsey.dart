...
class monsey extends StatefulWidget {
  const monsey({Key? key}) : super(key: key);

  @override
  _monseyState createState() => _monseyState();
}

class _monseyState extends State<monsey> with SingleTickerProviderStateMixin{
...
//
  ...
  List ar=await catgory.getallpost("32", i);
  setState(() {
    articles=ar;
