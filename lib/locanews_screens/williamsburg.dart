...
class williamsburg extends StatefulWidget {
  const williamsburg({Key? key}) : super(key: key);

  @override
  _williamsburgState createState() => _williamsburgState();
}

class _williamsburgState extends State<williamsburg> with SingleTickerProviderStateMixin{
...
//
  ...
  List ar=await catgory.getallpost("34", i);
  setState(() {
    articles=ar;
