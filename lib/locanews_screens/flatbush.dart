...
class flatbush extends StatefulWidget {
  const flatbush({Key? key}) : super(key: key);

  @override
  _flatbushState createState() => _flatbushState();
}

class _flatbushState extends State<flatbush> with SingleTickerProviderStateMixin{
...
//
  ...
  List ar=await catgory.getallpost("33", i);
  setState(() {
    articles=ar;
