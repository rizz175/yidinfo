...
class latestmusic extends StatefulWidget {
  const latestmusic({Key? key}) : super(key: key);

  @override
  _latestmusicState createState() => _latestmusicState();
}

class _latestmusicState extends State<latestmusic> with SingleTickerProviderStateMixin{
...
//
  ...
  List ar=await catgory.getallpost("52", i);
  setState(() {
    articles=ar;
            ...
            children: [
              Row(children: [
                ...
                Padding(
                  ...
                  child: Text("Latest Music",style:TextStyle(fontSize: 30,fontWeight:FontWeight.bold),),
                )
              ],),
                      ...
                      return GestureDetector(
                          ...
                          onTap:(){
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (BuildContext context) =>musicdetailscreen(articles[i]),
                                ));
                          },
                          child: Container(
